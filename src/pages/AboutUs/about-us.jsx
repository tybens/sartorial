      ...
      <Grid item container className={classes.contentBlock} spacing={4}>
        <Grid item xs={12}>
          ...
          <Typography variant="caption" className={classes.caption}>
            ...
            have a wide background, each contributing unique skills that push us to succeed and grow.
          </Typography>
        </Grid>
        <Grid
          item
